...
A short custom program that takes in the name of a text file and a case-sensitive whitespace-sensitive string. All occurrences of the string within the text file are replaced with a newline.
